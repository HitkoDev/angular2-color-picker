...
var color_picker_class_1 = require('./color-picker.class');
    ...
    ColorPickerDirective.prototype.onClick = function () {
        ...
        if (!this.created) {
            ...
            this.compiler.compileModuleAndAllComponentsAsync(DynamicCpModule)
                ...
                var injector = core_2.ReflectiveInjector.fromResolvedProviders([], _this.vcRef.parentInjector);
                var cmpRef = _this.vcRef.createComponent(compFactory, 0, injector, []);
                cmpRef.instance.setDialog(_this, _this.el, _this.colorPicker, _this.cpOptions);
...
var DialogComponent = (function () {
    ...
    DialogComponent = __decorate([
        ...
        __metadata('design:paramtypes', [core_1.ElementRef, color_picker_service_1.ColorPickerService, platform_browser_1.DomSanitizer])
    ], DialogComponent);
